...
$$
	V_1(\varphi)(x)=\int_\Gamma G(x,y)\varphi(y)d\sigma_y - \textrm{потенціал простого шару},
$$ 
$$
	V_2(\varphi)(x)=\int_\Gamma\frac{\partial}{\partial n_y}G(x,y)\varphi(y) d\sigma_y  - \textrm{потенціал подвійного шару},
$$
...
Подамо рівняння \eqref{eq} через оператори. 
 ...
 \begin{equation}
 \begin{split}
	&(S_{2k}\varphi)(s)=\frac{1}{2\pi}\int_{0}^{2\pi}H_{2k}(s, \sigma)\varphi_k(\sigma)d\sigma, \\ 
	&(S_{2k}\psi)(s)=\frac{1}{2\pi}\int_{0}^{2\pi}H_{2k}(s, \sigma)\psi(\sigma)d\sigma. \nonumber
 \end{split}
 \end{equation}
...
\begin{equation}
 ...
 Аналогічно для оператора $S$ відносно функціі $\psi_1$,
...
\begin{equation}
	(S^{'}[r,\psi]q)(s)=\frac{1}{8\pi}\int_{0}^{2\pi}q(\sigma)N_{r}(s, \sigma)\psi(\sigma)d\sigma.
 \end{equation}
\end{document}