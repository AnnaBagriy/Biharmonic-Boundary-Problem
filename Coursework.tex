...
\begin{gather*}
	...
	\hat{H}^{(1)}_{ll}(s, \sigma)= -\frac{1}{4}n(x_l(s))\cdot n(x_l(\sigma)), \\
	 ...
	 \hat{\hat{H}}^{(2)}_{ll}(s, \sigma) = \frac{1-\nu}{2\pi}\Big(\frac{(n(x_l(s))\cdot(x_l(s)-x_l(\sigma)))^2n(x_l(\sigma))\cdot(x_l(s)-x_l(\sigma))}{|x_l(s)-x_l(\sigma)|^4} \\
	 -\frac{n(x_l(s))\cdot n(x_l(\sigma))n(x_l(s))\cdot(x_l(s)-x_l(\sigma))}{|x_l(s)-x_l(\sigma)|^2} \Big)
	-\frac{(1+\nu)n(x_l(\sigma))\cdot(x_l(s)-x_l(\sigma))}{4\pi|x_l(s)-x_l(\sigma)|^2}\\
